          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Delivery ({order.deliveryZone?.name ?? "—"})</span>
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="text-sm space-y-2">
              ...
              {order.userId ? (
                <Badge variant="outline" className="text-xs">Registered customer</Badge>
              ) : (
                <Badge variant="outline" className="text-xs">Guest checkout</Badge>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Delivery zone: {order.deliveryZone?.name ?? "—"}
              </p>
              {order.deliveryZone && (
                <p className="text-xs text-muted-foreground">
                  Est. {order.deliveryZone.estimatedDays} day{order.deliveryZone.estimatedDays === 1 ? "" : "s"}
                </p>
              )}
              {order.notes && (
                <>
