    ...
    body: (
      <div className="space-y-4 text-sm text-muted-foreground">
        <p className="flex items-center gap-2">
          ...
          <a href="https://wa.me/8801602316968" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
            +880 1602-316968 (WhatsApp / Call)
          </a>
        </p>
        <p className="flex items-center gap-2">
          <a href="mailto:budget.king.86@gmail.com" className="hover:text-primary transition-colors">
            budget.king.86@gmail.com
          </a>
        </p>
        <p className="flex items-center gap-2">
          <a
        ...
        <p className="text-xs pt-4 border-t">Customer support hours: 10am–8pm (Sat–Thu)</p>
      </div>
    ),
  },
  privacy: {
    ...
    body: (
      <div className="space-y-3 text-sm text-muted-foreground">
        ...
        <p>For any privacy concerns, contact us at <a href="mailto:budget.king.86@gmail.com" className="text-primary hover:underline">budget.king.86@gmail.com</a>.</p>
      </div>
    ),
  },
  terms: {
