...
The **next major planning area should be #5 — Order & Delivery System**, because cancellation, agent workflow, delivery fees, group delivery, status transitions, and inventory reservations all depend on its rules.
